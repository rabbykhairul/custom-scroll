...
import { styleRoot, styleChild, styles } from './styles.css.js';
...
const isScrollInteraction = (i) => i === "scroll";
...
class PinchZoom extends React.Component<Props> {
  ...
  _updateInteraction(event: TouchEvent) {
    ...
    } else if (fingers === 1 && !this._canDrag()) {
      console.log("\n===");
      console.log("scroll interaction detected");
      console.log("===\n");
      return this._setInteraction("scroll", event);
    }
  ...
  _handlerOnTouchEnd = this._handlerIfEnable(
  ...
  _handlerOnTouchMove = this._handlerIfEnable(
    (touchMoveEvent: TouchEvent) => {
      ...
      console.log("\n===");
      console.log("inside touch move event handler");
      console.log("interaction type: ", this._interaction);
      console.log("===\n");
      ...
      if (this._firstMove) {
        ...
        if (this._interaction && isScrollInteraction(this._interaction)) {
          console.log("\n====");
          console.log("found scroll interaction on touch move");
          console.log("====\n");
          this._update();
